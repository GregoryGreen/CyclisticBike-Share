-- Combined all 12 datasets (12 months) and removed columns: start_lat, start_lng, end_lat, end_lng, start_station_id,end_station_id, end_station_name that won't be used
for analysis
